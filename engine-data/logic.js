export const JURISDICTIONS = {
    AE: { name: 'UAE', currency: 'AED', taxLabel: 'VAT', taxRate: 5, decimals: 2, major: 'Dirham', minor: 'Fils', hasSplitTax: false },
    ...
    US: { name: 'USA', currency: 'USD', taxLabel: 'Sales Tax', taxRate: 0, decimals: 2, major: 'Dollar', minor: 'Cents', hasSplitTax: false }
};
...
export const amountToWords = (total, config) => {
    ...
    while (majorNum > 0) {
        ...
        majorNum = Math.floor(majorNum / 1000);
        scaleIdx++;
    }
