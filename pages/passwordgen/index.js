    ...
    return (
        <ToolboxLayout title="Password Generator" description="Generate secure passwords and track your history.">
            <div style={{ maxWidth: '500px', margin: '0 auto', padding: '40px 20px', textAlign: 'center' }}>
                ...
                {history.length > 0 && (
                    <div style={{ textAlign: 'left', background: '#1e293b', padding: '20px', borderRadius: '20px', border: '1px solid #334155' }}>
                ...
                <div style={{ marginTop: '60px', borderTop: '1px solid #334155', paddingTop: '40px', color: '#94a3b8', fontSize: '0.95rem', lineHeight: '1.8', textAlign: 'left' }}>
                    <h2 style={{ color: '#38bdf8' }}>Professional Secure Password Generator</h2>
                    <p>
                        The SHB Password Generator is a security-focused utility designed to help you create complex, 
                        unpredictable, and crack-proof passwords. In an age of increasing cyber threats, 
                        using a unique and strong password for every account is the most effective way to 
                        protect your digital identity.
                    </p>

                    <h3 style={{ color: '#38bdf8', marginTop: '30px' }}>What Makes a Password Strong?</h3>
                    <p>
                        A secure password should be difficult for both humans and computers to guess. Our generator 
                        follows industry standards by mixing character types:
                    </p>
                    <ul>
                        <li><strong>Uppercase & Lowercase:</strong> Mixing cases increases combinations.</li>
                        <li><strong>Numbers:</strong> Integrating digits prevents dictionary attacks.</li>
                        <li><strong>Special Characters:</strong> Symbols like ! or @ add a layer of complexity.</li>
                    </ul>

                    <h3 style={{ color: '#38bdf8', marginTop: '30px' }}>Privacy and Security</h3>
                    <p>
                        Unlike many online generators, the SHB ToolBox operates entirely <strong>client-side</strong>. 
                        Your generated passwords never touch our servers or database. All logic happens 
                        locally in your browser, keeping your sensitive information safe.
                    </p>
                </div>
